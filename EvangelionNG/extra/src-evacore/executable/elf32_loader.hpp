...
{
public:
	static Elf32SpawnStatus spawnFromRamdisk(RamdiskEntry *binaryFile, SecurityLevel securityLevel, Thread **target, bool enforceCurrentCore, ThreadPriority priority);
