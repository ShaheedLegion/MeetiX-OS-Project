...
public:
	...
	bool runTermCommand(string command, Fd *termIn, Fd *termOut, Fd *termErr, Pid *intPid);

	/**
	 *
	 */
	bool execute(string shortpath, string args, Pid *outPid, Fd outStdio[3], Fd inStdio[3]);
