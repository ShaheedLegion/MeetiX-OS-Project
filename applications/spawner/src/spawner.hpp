 ...
 */
bool setupStdio(Pid createdPid, Pid requesterPid, Fd *outInw, Fd *outOutr, Fd *outErr, Fd inStdin, Fd inStdout, Fd inStderr);
 ...
 */
SpawnStatus spawn(const char *path, const char *args, const char *workdir, SecurityLevel sec_lvl, Pid requesterPid, Pid *outPid, Fd *outStdin, Fd *outStdout, Fd *outStderr, Fd inStdin, Fd inStdout, Fd inStderr);
