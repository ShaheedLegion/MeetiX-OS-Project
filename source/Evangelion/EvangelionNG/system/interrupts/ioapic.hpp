...
public:
	 ...
	 *
	 */
	uint32_t getGlobalSystemInterruptBase() const { return globalSystemInterruptBase; }

	/**
	 *
	 */
	uint32_t getRedirectEntryCount() const { return redirectEntryCount; }

	/**
	 *
	 */
	IoApic *getNext() const { return next; }
