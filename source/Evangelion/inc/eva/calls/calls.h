...
#define SYSCALL_GET_TASK_IDENTIFIER                 0x105
#define SYSCALL_GET_PROCESS_ID_FOR_TASK_ID			0x106
#define SYSCALL_FORK								0x107
#define SYSCALL_JOIN								0x108
#define SYSCALL_SLEEP								0x109
#define SYSCALL_ATOMIC_LOCK							0x10A
#define SYSCALL_WAIT_FOR_IRQ						0x10B
#define SYSCALL_LOG									0x10C
#define SYSCALL_SET_VIDEO_LOG						0x10D
#define SYSCALL_TEST								0x10E
#define SYSCALL_STORE_CLI_ARGUMENTS					0x10F
#define SYSCALL_RELEASE_CLI_ARGUMENTS				0x110
#define SYSCALL_GET_WORKING_DIRECTORY				0x111
#define SYSCALL_SET_WORKING_DIRECTORY				0x112
#define SYSCALL_KILL								0x113
#define SYSCALL_ATOMIC_BLOCK						0x114
#define SYSCALL_REGISTER_IRQ_HANDLER				0x115
#define SYSCALL_RESTORE_INTERRUPTED_STATE			0x116
#define SYSCALL_REGISTER_SIGNAL_HANDLER				0x117
#define SYSCALL_RAISE_SIGNAL						0x118
#define SYSCALL_ATOMIC_TRY_LOCK						0x119
#define SYSCALL_EVAQUERY							0x11A
#define SYSCALL_GET_EXECUTABLE_PATH					0x11B
#define SYSCALL_EXIT_THREAD							0x11C
#define SYSCALL_GET_PARENT_PROCESS_ID				0x11D	
...
#define SYSCALL_SOUND                         		0x801
#define SYSCALL_SOUNDMUTE							0x802
