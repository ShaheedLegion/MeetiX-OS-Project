...
#define SECURITY_LEVEL_APPLICATION		2
...
static const ThreadType THREAD_TYPE_MAIN = 0;
static const ThreadType THREAD_TYPE_SUB  = 1;
static const ThreadType THREAD_TYPE_VM86 = 2;
