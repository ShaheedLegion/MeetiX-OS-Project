...
#include <mxuser/graphics/color.hpp>
...
public:
	...
	virtual void write(std::string message, ColorArgb color = RGB(255, 255, 255), bool visible = true) = 0;
	virtual void writeChar(char c, ColorArgb color = RGB(255, 255, 255)) = 0;
