...
public:
	//
	Elf32Loader(ProcessCreationIdentifier target, Fd file) : Loader(target, file) {}
	...
	//
	static LoaderStatus readAndValidateElfHeader(Fd file, Elf32Ehdr *hdrBuf);
	static LoaderStatus checkForElfBinaryAndReset(Fd file);
